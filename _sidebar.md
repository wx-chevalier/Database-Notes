  ...
  - [6 数据库理论](/数据库理论/README.md)
    ...
    - [6.3 存储引擎](/数据库理论/存储引擎/README.md)
      ...
      - [6.3.3 其他索引](/数据库理论/存储引擎/其他索引.md)
      - [6.3.4 哈希索引](/数据库理论/存储引擎/哈希索引.md)
      - [6.3.5 无索引](/数据库理论/存储引擎/无索引.md)
      - [6.3.6 编码](/数据库理论/存储引擎/编码.md)
    - [6.4 数据仓库](/数据库理论/数据仓库/README.md)
      ...
      - [6.4.2 多维数据模型](/数据库理论/数据仓库/多维数据模型/README.md)
        ...
        - [6.4.2.3 多维数据库](/数据库理论/数据仓库/多维数据模型/多维数据库.md)
        - [6.4.2.4 星型与雪花模型](/数据库理论/数据仓库/多维数据模型/星型与雪花模型.md)
      - [6.4.3 记录与衍生](/数据库理论/数据仓库/记录与衍生/README.md)
        - [6.4.3.1 变更数据捕获](/数据库理论/数据仓库/记录与衍生/变更数据捕获.md)
        - [6.4.3.2 混合存储](/数据库理论/数据仓库/记录与衍生/混合存储.md)
        - [6.4.3.3 观察衍生数据状态](/数据库理论/数据仓库/记录与衍生/观察衍生数据状态.md)
        - [6.4.3.4 避免错误](/数据库理论/数据仓库/记录与衍生/避免错误.md)
  ...
  - 9 键值型数据库
    ...
    - [9.3 Redis](/键值型数据库/Redis/README.md)
      ...
      - [9.3.3 数据操作](/键值型数据库/Redis/数据操作/README.md)
        ...
        - [9.3.3.4 键基础](/键值型数据库/Redis/数据操作/键基础.md)
        - [9.3.3.5 集合类型](/键值型数据库/Redis/数据操作/集合类型.md)
      - [9.3.4 架构机制](/键值型数据库/Redis/架构机制/README.md)
        - [9.3.4.1 事件循环](/键值型数据库/Redis/架构机制/事件循环.md)
        - [9.3.4.2 命令执行](/键值型数据库/Redis/架构机制/命令执行.md)
        - [9.3.4.3 客户端通信](/键值型数据库/Redis/架构机制/客户端通信.md)
        - [9.3.4.4 数据类型实现](/键值型数据库/Redis/架构机制/数据类型实现.md)
        - [9.3.4.5 进程架构](/键值型数据库/Redis/架构机制/进程架构.md)
