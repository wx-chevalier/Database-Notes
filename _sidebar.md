  ...
  - [6 数据库基础](/数据库基础/README.md)
    - [6.1 事务](/数据库基础/事务/README.md)
      ...
      - [6.1.2 隔离级别](/数据库基础/事务/隔离级别/README.md)
        - [6.1.2.1 可序列化](/数据库基础/事务/隔离级别/可序列化.md)
        - [6.1.2.2 快照隔离与可重复读](/数据库基础/事务/隔离级别/快照隔离与可重复读.md)
        - [6.1.2.3 读已提交](/数据库基础/事务/隔离级别/读已提交.md)
        - [6.1.2.4 读未提交](/数据库基础/事务/隔离级别/读未提交.md)
        - [6.1.2.5 防止丢失更新](/数据库基础/事务/隔离级别/防止丢失更新.md)
    - [6.2 存储引擎](/数据库基础/存储引擎/README.md)
      - 6.2.1 全文索引
        - [6.2.1.1 全文索引](/数据库基础/存储引擎/全文索引/全文索引.md)
        - [6.2.1.2 动态全文索引](/数据库基础/存储引擎/全文索引/动态全文索引.md)
      - [6.2.2 索引](/数据库基础/存储引擎/索引/README.md)
        - [6.2.2.1 B+ 树](/数据库基础/存储引擎/索引/B+%20树.md)
        - [6.2.2.2 LSM 树](/数据库基础/存储引擎/索引/LSM%20树.md)
        - [6.2.2.3 其他索引](/数据库基础/存储引擎/索引/其他索引.md)
        - [6.2.2.4 哈希索引](/数据库基础/存储引擎/索引/哈希索引.md)
        - [6.2.2.5 无索引](/数据库基础/存储引擎/索引/无索引.md)
      - [6.2.3 编码](/数据库基础/存储引擎/编码.md)
    - [6.3 数据仓库](/数据库基础/数据仓库/README.md)
      ...
      - [6.3.3 大数据](/数据库基础/数据仓库/大数据/README.md)
        - [6.3.3.1 不作恶](/数据库基础/数据仓库/大数据/不作恶.md)
        - [6.3.3.2 大数据平台](/数据库基础/数据仓库/大数据/大数据平台.md)
        - [6.3.3.3 大数据生态圈](/数据库基础/数据仓库/大数据/大数据生态圈.md)
        - [6.3.3.4 大数据的未来](/数据库基础/数据仓库/大数据/大数据的未来.md)
        - [6.3.3.5 数据的特性](/数据库基础/数据仓库/大数据/数据的特性.md)
      - 6.3.4 数据流
        - [6.3.4.1 混合存储](/数据库基础/数据仓库/数据流/混合存储.md)
      - [6.3.5 记录与衍生](/数据库基础/数据仓库/记录与衍生/README.md)
        - [6.3.5.1 变更数据捕获](/数据库基础/数据仓库/记录与衍生/变更数据捕获.md)
        - [6.3.5.2 物化视图](/数据库基础/数据仓库/记录与衍生/物化视图.md)
        - [6.3.5.3 观察衍生数据状态](/数据库基础/数据仓库/记录与衍生/观察衍生数据状态.md)
        - [6.3.5.4 避免错误](/数据库基础/数据仓库/记录与衍生/避免错误.md)
