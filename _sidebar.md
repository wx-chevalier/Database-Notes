  ...
  - [6 数据库基础](/数据库基础/README.md)
    ...
    - [6.2 大数据](/数据库基础/大数据/README.md)
      - [6.2.1 不作恶](/数据库基础/大数据/不作恶.md)
      - [6.2.2 大数据平台](/数据库基础/大数据/大数据平台.md)
      - [6.2.3 大数据生态圈](/数据库基础/大数据/大数据生态圈.md)
      - [6.2.4 大数据的未来](/数据库基础/大数据/大数据的未来.md)
      - [6.2.5 数据的特性](/数据库基础/大数据/数据的特性.md)
    - [6.3 存储引擎](/数据库基础/存储引擎/README.md)
      - [6.3.1 B+ 树](/数据库基础/存储引擎/B+%20树.md)
      - [6.3.2 LSM 树](/数据库基础/存储引擎/LSM%20树.md)
      - 6.3.3 全文索引
        - [6.3.3.1 全文索引](/数据库基础/存储引擎/全文索引/全文索引.md)
        - [6.3.3.2 动态全文索引](/数据库基础/存储引擎/全文索引/动态全文索引.md)
      - [6.3.4 其他索引](/数据库基础/存储引擎/其他索引.md)
      - [6.3.5 哈希索引](/数据库基础/存储引擎/哈希索引.md)
      - [6.3.6 无索引](/数据库基础/存储引擎/无索引.md)
      - [6.3.7 编码](/数据库基础/存储引擎/编码.md)
    - [6.4 数据仓库](/数据库基础/数据仓库/README.md)
      - [6.4.1 列存储](/数据库基础/数据仓库/列存储/README.md)
        - [6.4.1.1 写入与更新](/数据库基础/数据仓库/列存储/写入与更新.md)
      - [6.4.2 多维数据模型](/数据库基础/数据仓库/多维数据模型/README.md)
        - [6.4.2.1 Data Cube](/数据库基础/数据仓库/多维数据模型/Data%20Cube.md)
        - [6.4.2.2 元数据](/数据库基础/数据仓库/多维数据模型/元数据.md)
        - [6.4.2.3 星型与雪花模型](/数据库基础/数据仓库/多维数据模型/星型与雪花模型.md)
      - 6.4.3 数据流
        - [6.4.3.1 混合存储](/数据库基础/数据仓库/数据流/混合存储.md)
      - [6.4.4 记录与衍生](/数据库基础/数据仓库/记录与衍生/README.md)
        - [6.4.4.1 变更数据捕获](/数据库基础/数据仓库/记录与衍生/变更数据捕获.md)
        - [6.4.4.2 物化视图](/数据库基础/数据仓库/记录与衍生/物化视图.md)
        - [6.4.4.3 观察衍生数据状态](/数据库基础/数据仓库/记录与衍生/观察衍生数据状态.md)
        - [6.4.4.4 避免错误](/数据库基础/数据仓库/记录与衍生/避免错误.md)
    - [6.5 数据库简史](/数据库基础/数据库简史/README.md)
      - [6.5.1 DBMS](/数据库基础/数据库简史/DBMS.md)
      - [6.5.2 NoSQL](/数据库基础/数据库简史/NoSQL.md)
      - [6.5.3 性能评测](/数据库基础/数据库简史/性能评测.md)
    - [6.6 数据模型](/数据库基础/数据模型/README.md)
      - [6.6.1 关系模型](/数据库基础/数据模型/关系模型.md)
      - [6.6.2 图模型](/数据库基础/数据模型/图模型.md)
      - [6.6.3 文档模型](/数据库基础/数据模型/文档模型.md)
      - [6.6.4 时序模型](/数据库基础/数据模型/时序模型.md)
      - [6.6.5 查询语言](/数据库基础/数据模型/查询语言.md)
  - 7 文档型数据库
